...
import StorySkeleton from "./skeletonScreens/StorySkeleton";
...
const StoriesBar = () => {
  ...
  "
        >
          <div
            ...
            className="h-full w-full bg-zinc-600 rounded-full flex justify-center items-center"
          >
        ...
        {AuthUserStory && (
          <div
            id="border"
            onClick={() => handleStoryClick(AuthUserStory)}
            className="
  ...
  "
    ...
    "
      ...
      {isfullScreen && (
        <StoriesFullContainer story={selectedStory} onClose={closeFullScreen} />
      )}
    </>
  );
};
